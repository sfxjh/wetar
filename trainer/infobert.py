...
class InfoBertTrainer(BaseTrainer):
    ...
    def add_args(parser):
        ...
        group.add_argument('--adv_steps', default=3, type=int,
                            help='Number of gradient ascent steps for the adversary')
        group.add_argument('--adv_learning_rate', default=4e-2, type=float,
                            help='Step size of gradient ascent')
        group.add_argument('--adv_init_mag', default=8e-2, type=float,
                            help='Magnitude of initial (adversarial?) perturbation')
        group.add_argument('--adv_max_norm', default=0, type=float,
        ...
        group.add_argument('--ch', default=0.9, type=float,
                            help='lower bound of Local Anchored Feature Extraction')
        group.add_argument('--info_seed', default=42, type=float,
