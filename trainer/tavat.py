...
class TokenAwareVirtualAdversarialTrainer(BaseTrainer):
    ...
    def add_args(parser):
        ...
        group.add_argument('--adv_steps', default=2, type=int,
                            help='Number of gradient ascent steps for the adversary')
        group.add_argument('--adv_learning_rate', default=5e-2, type=float,
                            help='Step size of gradient ascent')
        group.add_argument('--adv_init_mag', default=2e-1, type=float,
                            help='Magnitude of initial (adversarial?) perturbation')
        group.add_argument('--adv_max_norm', default=5e-1, type=float,
        ...
        group.add_argument('--use_global_embedding', default=True, type=bool,
