...
class GreedyWordSwapWIR(SearchMethod):
    ...
    def _perform_search(self, initial_result):
        ...
        cur_result.adversarial_result = cur_result
        results = None
        while i < len(index_order) and not search_over:
            ...
            if results[0].score > cur_result.score:
                results[0].adversarial_result = cur_result
            ...
            if cur_result.goal_status == GoalFunctionResultStatus.SUCCEEDED:
                ...
                for result in results:
                    if result.goal_status != GoalFunctionResultStatus.SUCCEEDED:
                        if result.score > cur_result.adversarial_result.score:
                            # cur_result.adversarial_result = result
                            best_result.adversarial_result = result
                        break
